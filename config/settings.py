...
INSTALLED_APPS = [
    ...
    "socialaccount.apps.SocialaccountConfig",
...
DATABASES = {
    "default": {
        ...
        # "HOST": "db",  # set in docker-compose.yml
        "HOST": "xxxxxxxxxxxxxxxxxxxxxxxxxxxx",  # set in docker-compose.yml
        "PORT": 5432,  # default postgres port
        "CONN_MAX_AGE": 1000,  # pooling
    }
}
...
AUTHENTICATION_BACKENDS = (
    ...
    "user.auth_backends.PhoneAuthBackend",
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "xxxxxxxxxxxxxxxxxxxxxx"  # this is exactly the value 'apikey'
EMAIL_HOST_PASSWORD = (
